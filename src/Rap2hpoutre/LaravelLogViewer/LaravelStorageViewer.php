...
class LaravelStorageViewer
{
    ...
    /**
     * LaravelStorageViewer constructor.
     */
    public function __construct()
    {
        $this->level = new Level();
        $this->pattern = new Pattern();
        $this->storage_path = function_exists('config') ? config('storageviewer.storage_path', storage_path('logs')) : storage_path('logs');
    ...
    public function all()
    {
        ...
        $max_file_size = function_exists('config') ? config('storageviewer.max_file_size', self::MAX_FILE_SIZE) : self::MAX_FILE_SIZE;
   ...
   /**Returns an array of
    ...
    {
        $files = [];
	    $pattern = function_exists('config') ? config('storageviewer.pattern', '*.log') : '*.log';
